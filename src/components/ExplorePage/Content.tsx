...
const Content = (props: any) => {
  ...
  return (
    <Grid container item justifyContent="space-between" alignItems="center" direction="column" spacing={2}>
      <Grid item>
        <Typography variant="h5" className="add-your-files">
          {isFileUploaded ? 'Replace your files' : 'Add your files'}
        </Typography>
      </Grid>
      <Grid item>
